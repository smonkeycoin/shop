...
export default async function AdminDashboardPage({ searchParams }: AdminDashboardPageProps) {
  const { includeTest: includeTestParam } = await searchParams;
  ...
  return (
    <>
      ...
      <p className="admin-page-subcopy">
        Aqui esta el estado de Shop NeumoPractice. {dashboard.includeTest ? "Incluye pedidos test/demo." : "Excluye pedidos test/demo."}
      </p>
