...
import { categories, publicBrands, publicProducts, searchProducts, subcategories } from "@/data/catalog";
...
export function ProductListing({
  ...
  const filteredProducts = useMemo(() => {
    const baseProducts = query ? searchProducts(query) : publicProducts;
    ...
    <section className="catalog-page section-shell">
      ...
      <header className="catalog-hero">
        ...
        <div className="catalog-count">
          ...
          <span>de {publicProducts.length} productos</span>
        </div>
      </header>
