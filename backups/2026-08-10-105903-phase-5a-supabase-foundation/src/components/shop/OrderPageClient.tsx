...
export function OrderPageClient({ orderNumber }: { orderNumber: string }) {
  const { getOrder } = useOrders();
  // TODO: protect order access server-side before production.
    ...
    return (
      <section className="section-shell order-page">
        ...
        <div className="empty-state order-not-found">
          ...
          <h1>No encontramos este pedido en este navegador.</h1>
          <p>Los pedidos de esta fase son locales. Puedes consultarlo si fue creado en este mismo dispositivo.</p>
