...
import {
  ...
  publicBrands as localPublicBrands,
  publicProducts as localPublicProducts,
  searchProducts,
  subcategories,
} from "@/data/catalog";
import type { Brand, Category, Product, StockStatus } from "@/types/commerce";
...
export function ProductListing({
  ...
  lockedFilters = false,
  products = localPublicProducts,
  brands = localPublicBrands,
  ...
  const filteredProducts = useMemo(() => {
    const baseProducts = query ? searchCatalogProducts(query, products) : products;
  ...
  }, [availability, brandSlug, categorySlug, priceRange, products, query, sort, subcategorySlug, useTag]);
...
function searchCatalogProducts(query: string, products: Product[]) {
  if (products === localPublicProducts) {
