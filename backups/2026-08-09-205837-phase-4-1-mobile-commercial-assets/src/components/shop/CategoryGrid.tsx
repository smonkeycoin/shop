...
const categoryAssets: Record<string, { src?: string; alt: string; className?: string }[]> = {
  aerocamaras: [
    { src: "/products/vortex/vortex-spacer-baby-mask-reference.jpg", alt: "VORTEX", className: "wide" },
  ],
  nebulizacion: [{ alt: "Nebulización pendiente de SKU", className: "pending" }],
  "higiene-nasal": [
    { src: "/products/neilmed/neilmed-pediamist-front-cutout-reference.png", alt: "NeilMed" },
    { src: "/products/sterimar/sterimar-breathe-easy-daily-front-reference.png", alt: "Stérimar" },
  ],
  monitoreo: [{ alt: "Flujómetro pendiente de SKU", className: "pending" }],
  "terapia-respiratoria": [{ alt: "Terapia respiratoria pendiente de SKU", className: "pending" }],
  accesorios: [{ alt: "Accesorio pendiente de SKU", className: "pending" }],
};
