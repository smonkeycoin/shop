...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      order_inventory_allocations: {
        Row: {
          ...
          product_id: string
          quantity_reserved: number
          release_applied_at: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "order_inventory_allocations_inventory_id_fkey"
          ...
          {
            foreignKeyName: "order_inventory_allocations_order_item_id_fkey"
          ...
          {
            foreignKeyName: "order_inventory_allocations_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "products"
            referencedColumns: ["id"]
      ...
      orders: {
        Row: {
          ...
          inventory_release_applied_at: string | null
          inventory_sale_applied_at: string | null
          is_test: boolean
          order_number: string
    ...
    Functions: {
      ...
      create_order_transaction: { Args: { payload: Json }; Returns: Json }
      create_order_transaction_v2: { Args: { payload: Json }; Returns: Json }
      get_public_order: {
        Args: { lookup_token_input: string; order_number_input: string }
        Returns: Json
      }
